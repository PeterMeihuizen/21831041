...
In order to be a successful streaming company, we need people to watch our content therefore I will use imdb_votes as the metric for viewership and see what factors atracts people to watch particular content. I have decided that I am only going to look at what makes shows popular and successful and exclude movies. The reason for this is that shows have a much longer runtime overall than movies meaning people are much more inclined to have a subscription to a streaming service if has got a good show compared to a good movie, because a show will provide more hours of entertainment. Ok so using the actors and netflix data set, I am  going to look at the top 200 shows most viewed shows and see the breakdown of these shows by genre.
...
Ok now that I have seprated the data sets, we can work out the most popular 200 shows to see what genres are popular.  

```{r}
top200_shows <- top200(shows)
```
